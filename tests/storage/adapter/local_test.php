 ...
 */
 ...
 class phpbb_storage_adapter_local_test extends phpbb_test_case
 {
	...
	public function setUp()
	{
		...
		$this->adapter = new \phpbb\storage\adapter\local($config, $this->filesystem, new \FastImageSize\FastImageSize(), new \phpbb\mimetype\guesser(array(new \phpbb\mimetype\extension_guesser)), $phpbb_root_path);
