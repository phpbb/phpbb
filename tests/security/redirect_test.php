...
class phpbb_security_redirect_test extends phpbb_security_test_base
{
	...
	public static function provider()
	{
		...
		return array(
			...
			array('http://localhost/phpBB/index.php/foobar', false, false, 'http://localhost/phpBB/index.php/foobar'),
			array('./index.php/foobar', false, false, 'http://localhost/phpBB/index.php/foobar'),
			array('index.php/foobar', false, false, 'http://localhost/phpBB/index.php/foobar'),
			array('./../index.php/foobar', false, false, 'http://localhost/index.php/foobar'),
			array('./../index.php/foobar', true, false, 'http://localhost/index.php/foobar'),
			array('./../index.php/foo/bar', false, false, 'http://localhost/index.php/foo/bar'),
			array('./../index.php/foo/bar', true, false, 'http://localhost/index.php/foo/bar'),
			...
			array('index.php/a', false, false, 'http://localhost/phpBB/index.php/a'),
			array('index.php/a/b', false, false, 'http://localhost/phpBB/index.php/a/b'),
			array('./index.php/', false, false, 'http://localhost/phpBB/index.php/'),
