...
class phpbb_api_auth_test extends phpbb_database_test_case
{
	...
	{
		return array(
			array(1, false, 'guest', '', 'Guest access should give the user id 1 when guests have permissions'),
			array(2, false, 'aaaaaaaaaaaaaaaa', 'c838ce3a204b683c5a552aba35c7b8f3eb865e30db760dd65677567dba8a7963','Valid key and hash should give user id 2'),
			array(401, true, 'invalid', 'invalid', 'Non-existant auth_key should give http status code 401'),
			array(403, true, 'aaaaaaaaaaaaaaaa', 'c838ce3a204b683c5a552aba35c7b8f3eb865e30db760dd65677567dba8a7963','Valid key and hash but no permissions should give 403'),
			array(400, true, 'aaaaaaaaaaaaaaaa', 'invalid','Invalid hash should give 400'),
		);
	}
	 ...
	 */
	public function test_auth($status, $nopermission, $auth_key, $hash, $description)
	{
		if (!$nopermission)
		{
