...
class phpbb_viewonline_helper_test extends phpbb_test_case
{
	...
	protected function setUp(): void
	{
		...
		$this->viewonline_helper = new \phpbb\members\viewonline_helper($db, $config, $dispatcher, $router, $controller_helper, $language, $auth, $phpbb_root_path, $phpEx, '%tables.users%', '%tables.sessions%', '%tables.topics%', '%tables.forums%');
	}
