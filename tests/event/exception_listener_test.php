...
class exception_listener extends phpbb_test_case
{
	...
	public function test_phpbb_exception($is_ajax, $exception, $expected)
	{
		...
		$acp_functions = $this->createMock('\phpbb\acp\functions\controller');

		$exception_listener = new \phpbb\event\kernel_exception_subscriber($template, $lang, $controller_helper, $acp_functions);
