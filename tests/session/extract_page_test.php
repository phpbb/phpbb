	...
	static public function extract_current_page_data()
	{
		return array(
			...
			array(
				...
				'/user/login',
				array(
					'page_name' => 'app.php/user/login',
					'page_dir' => '',
					'query_string' => '',
					'script_path' => '/phpBB/',
					'root_script_path' => '/phpBB/',
					'page' => 'app.php/user/login',
					'forum' => 0,
				),
			),
			array(
				...
				'/user/register',
				array(
					'page_name' => 'app.php/user/register',
					'page_dir' => '',
					'query_string' => '',
					'script_path' => '/phpBB/',
					'root_script_path' => '/phpBB/',
					'page' => 'app.php/user/register',
					'forum' => 0,
				),
			),
			array(
				...
				'/admin/index',
				array(
					'page_name' => 'app.php/admin/index',
					'page_dir' => '',
					'query_string' => '',
					'script_path' => '/phpBB/',
					'root_script_path' => '/phpBB/',
					'page' => 'app.php/admin/index',
					'forum' => 0,
				),
			),
			array(
				...
				'/admin/foo/bar',
				array(
					'page_name' => 'app.php/admin/foo/bar',
					'page_dir' => '',
					'query_string' => 'page=1&test=2',
					'script_path' => '/phpBB/',
					'root_script_path' => '/phpBB/',
					'page' => 'app.php/admin/foo/bar?page=1&test=2',
					'forum' => 0,
				),
			),
			array(
