...
class phpbb_upload_imagesize_test extends \phpbb_test_case
{
	...
	public static function data_get_imagesize()
	{
		return array(
			...
			array('gif', 'image/png', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_GIF)),
			array('png', '', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_PNG)),
			array('gif', 'image/gif', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_GIF)),
			array('jpg', 'image/gif', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_JPEG)),
			...
			array('png', 'image/jpg', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_PNG)),
			...
			array('png', 'image/tiff', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_PNG)),
			...
			array('png', 'image/vnd.wap.wbmp', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_PNG)),
			...
			array('png', 'image/iff', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_PNG)),
			array('png', 'image/x-iff', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_PNG)),
			...
			array('jpg', 'image/jp2', array('width' => 1, 'height' => 1, 'type' => IMAGETYPE_JPEG)),
