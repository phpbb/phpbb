...
class phpbb_functional_test_case extends phpbb_test_case
{
	...
	*/
	protected function create_topic($forum_id, $subject, $message, $additional_form_data = array())
	{
	...
	* @return array post_id, topic_id
	*/
	protected function create_post($forum_id, $topic_id, $subject, $message, $additional_form_data = array())
	{
	...
	*/
	protected function submit_post($posting_url, $posting_contains, $form_data)
	{
		...
		$url = $crawler->selectLink(str_replace('%s', '', $this->lang['VIEW_MESSAGE']))->link()->getUri();
