...
* @group functional
*/
class phpbb_functional_acp_groups_test extends phpbb_functional_test_case
{
	...
	*/
	public function test_groups_manage($input, $expected)
	{
		...
		$crawler = $this->request('GET', 'adm/index.php?i=groups&mode=manage&action=edit&g=5&sid=' . $this->sid);
