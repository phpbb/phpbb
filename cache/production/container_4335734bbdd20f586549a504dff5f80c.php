...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000045c9866f0000000068efbd73(
...
class phpbbtemplatetwiglexer_0000000045c9866f0000000068efbd73 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5aafd9b6791fd580486851 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5aafd9b679206035991067 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5aafd9b6791d9945165998 = array(
    ...
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, 'set_environment', array('env' => $env), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;

        return $this->valueHolder5aafd9b6791fd580486851->set_environment($env);
    }
    ...
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;

        return $this->valueHolder5aafd9b6791fd580486851->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;

        return $this->valueHolder5aafd9b6791fd580486851->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5aafd9b679206035991067 = $initializer;
    }
    ...
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, '__get', array('name' => $name), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;

        if (isset(self::$publicProperties5aafd9b6791d9945165998[$name])) {
            return $this->valueHolder5aafd9b6791fd580486851->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5aafd9b6791fd580486851;
    ...
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;
    ...
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, '__isset', array('name' => $name), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;
    ...
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, '__unset', array('name' => $name), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;
    ...
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, '__clone', array(), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;

        $this->valueHolder5aafd9b6791fd580486851 = clone $this->valueHolder5aafd9b6791fd580486851;
    }

    public function __sleep()
    {
        $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, '__sleep', array(), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;

        return array('valueHolder5aafd9b6791fd580486851');
    }
    ...
    {
        return $this->initializer5aafd9b679206035991067;
    }
    ...
    {
        return $this->initializer5aafd9b679206035991067 && ($this->initializer5aafd9b679206035991067->__invoke($valueHolder5aafd9b6791fd580486851, $this, 'initializeProxy', array(), $this->initializer5aafd9b679206035991067) || 1) && $this->valueHolder5aafd9b6791fd580486851 = $valueHolder5aafd9b6791fd580486851;
    }
    ...
    {
        return null !== $this->valueHolder5aafd9b6791fd580486851;
    }
    ...
    {
        return $this->valueHolder5aafd9b6791fd580486851;
    }
