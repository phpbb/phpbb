...
$template->assign_vars(array(
	...
	'U_MCP'				=> ($auth->acl_get('m_', $forum_id)) ? $controller_helper->route('mcp_view_forum', ['f' => $forum_id], true, $user->session_id) : '',
...
if (count($topic_list))
{
	...
	foreach ($topic_list as $topic_id)
	{
		...
		$topic_row = array(
			...
			'U_MCP_REPORT'			=> $controller_helper->route('mcp_report_details', ['f' => $row['forum_id'], 't' => $topic_id], true, $user->session_id),
