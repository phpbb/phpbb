...
<div class="action-bar top">
	...
	<?php  $this->set_filename('xs_include_7f10d97b2a9fba7344b3dc8d5d95e84b', 'viewtopic_topic_tools.html', true);  $this->pparse('xs_include_7f10d97b2a9fba7344b3dc8d5d95e84b');  ?>
	...
	<?php if ($this->vars['PAGINATION'] || $this->vars['TOTAL_POSTS']) {  ?>
		<div class="pagination">
			...
			<?php if ($this->vars['PAGINATION']) {  ?>
				<?php  $this->set_filename('xs_include_2c91a45c6e778bc89122cda5a34b3bf1', 'pagination.html', true);  $this->pparse('xs_include_2c91a45c6e778bc89122cda5a34b3bf1');  ?>
			<?php } else { ?>
...
<?php if ($this->vars['S_QUICK_REPLY']) {  ?>
	<?php  $this->set_filename('xs_include_56c30701c17a67328b9613fb98369e6f', 'quickreply_editor.html', true);  $this->pparse('xs_include_56c30701c17a67328b9613fb98369e6f');  ?>
<?php } ?>
...
<div class="action-bar bottom">
	...
	<?php  $this->set_filename('xs_include_12b4738cfff538880bb1700a7f1ad4a0', 'viewtopic_topic_tools.html', true);  $this->pparse('xs_include_12b4738cfff538880bb1700a7f1ad4a0');  ?>
...
?>
	...
	<?php if ($this->vars['PAGINATION'] || $this->vars['TOTAL_POSTS']) {  ?>
		<div class="pagination">
			...
			<?php if ($this->vars['PAGINATION']) {  ?>
				<?php  $this->set_filename('xs_include_b3e67985db62afd0c6de087ead6c18e2', 'pagination.html', true);  $this->pparse('xs_include_b3e67985db62afd0c6de087ead6c18e2');  ?>
			<?php } else { ?>
				&bull; <?php echo isset($this->vars['PAGE_NUMBER']) ? $this->vars['PAGE_NUMBER'] : $this->lang('PAGE_NUMBER'); ?>
			<?php } ?>
		</div>
...
<?php  $this->set_filename('xs_include_aa8905882acc2e3a28c56dd9a2c3600f', 'jumpbox.html', true);  $this->pparse('xs_include_aa8905882acc2e3a28c56dd9a2c3600f');  ?>
