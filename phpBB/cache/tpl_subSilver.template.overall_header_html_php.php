...
// eXtreme Styles mod cache. Generated on Tue, 09 Oct 2018 07:31:15 +0000 (time=1539070275)
...
<link href="<?php echo isset($this->vars['T_FONT_IONIC_LINK']) ? $this->vars['T_FONT_IONIC_LINK'] : $this->lang('T_FONT_IONIC_LINK'); ?>" rel="stylesheet" type="text/css" />
			...
			<div id="logodesc">
				...
				<table width="100%" align="center" cellspacing="0" cellpadding="5" border="0" class="table1 main_table">
					...
					<tr class="bg1">
						...
						<td class="table1 responsive-hide" align="left" valign="top"><a href="<?php if ($this->vars['U_SITE_HOME']) {  ?><?php echo isset($this->vars['U_SITE_HOME']) ? $this->vars['U_SITE_HOME'] : $this->lang('U_SITE_HOME'); ?><?php } else { ?><?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?><?php } ?>" class="imageset" ><img src="<?php echo isset($this->vars['T_THEME_PATH']) ? $this->vars['T_THEME_PATH'] : $this->lang('T_THEME_PATH'); ?>/images/<?php echo isset($this->vars['SITE_LOGO_IMG']) ? $this->vars['SITE_LOGO_IMG'] : $this->lang('SITE_LOGO_IMG'); ?>" border="0" alt="<?php echo isset($this->vars['L_INDEX']) ? $this->vars['L_INDEX'] : $this->lang('L_INDEX'); ?>" vspace="1" /></a></td>
					...
					<tr class="bg2"> 
						...
						<span class="mainmenu dropdown-trigger">
							<a href="#" class="dropdown-trigger">
								...
								<!-- img src="<?php echo isset($this->vars['T_THEME_PATH']) ? $this->vars['T_THEME_PATH'] : $this->lang('T_THEME_PATH'); ?>/images/icon_mini_forum.gif"  border="0" alt="<?php echo isset($this->vars['L_QUICK_LINKS']) ? $this->vars['L_QUICK_LINKS'] : $this->lang('L_QUICK_LINKS'); ?>" hspace="3" /-->
								</i>
							</a>
						</span>						
						...
						<td data-last-responsive="true" class="nav-main linklist table1 responsive-hide" role="menubar" height="15" align="center" valign="top"><span class="mainmenu">
							...
							<a href="<?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?>" title="<?php echo isset($this->vars['L_INDEX']) ? $this->vars['L_INDEX'] : $this->lang('L_INDEX'); ?>" role="menuitem" class="mainmenu">
								<i class="icon ion-md-cloud-outline fa-fw" aria-hidden="true"></i>
							</a>						
							</span>
						</td>
						...
						<td data-last-responsive="true" class="table1" height="15" align="center" valign="top">
							...
							<a href="<?php echo isset($this->vars['U_FAQ']) ? $this->vars['U_FAQ'] : $this->lang('U_FAQ'); ?>" title="<?php echo isset($this->vars['L_FAQ']) ? $this->vars['L_FAQ'] : $this->lang('L_FAQ'); ?>" role="menuitem" class="mainmenu" height="15" align="center" valign="top">
								<i class="icon ion-md-help-circle-outline fa-fw" aria-hidden="true"></i>
							</a>
							</span>
						</td>
						...
						<td data-last-responsive="true" class="table1 responsive-hide" height="15" align="center" valign="top">
							...
							<a href="<?php echo isset($this->vars['U_ACP']) ? $this->vars['U_ACP'] : $this->lang('U_ACP'); ?>" title="<?php echo isset($this->vars['L_ACP']) ? $this->vars['L_ACP'] : $this->lang('L_ACP'); ?>" role="menuitem" class="table1" height="15" align="center" valign="top">
								<i class="icon ion-ios-settings fa-fw" aria-hidden="true"></i>
							</a>
							</span>						
						</td>
						<?php } ?>
						...
						<td data-last-responsive="true" class="table1 responsive-hide" height="15" align="center" valign="top">
							...
							<a href="<?php echo isset($this->vars['U_MCP']) ? $this->vars['U_MCP'] : $this->lang('U_MCP'); ?>" title="<?php echo isset($this->vars['L_MCP']) ? $this->vars['L_MCP'] : $this->lang('L_MCP'); ?>" role="menuitem" class="mainmenu">
								<i class="icon fa-object-group fa-fw" aria-hidden="true"></i>
								<img src="<?php echo isset($this->vars['T_THEME_PATH']) ? $this->vars['T_THEME_PATH'] : $this->lang('T_THEME_PATH'); ?>/images/icon_mini_groups.gif" aria-hidden="true" border="0" alt="<?php echo isset($this->vars['L_MCP_SHORT']) ? $this->vars['L_MCP_SHORT'] : $this->lang('L_MCP_SHORT'); ?>" hspace="3" />								
							</a>
							</span>						
						</td>
						<?php } ?>						
						...
						<td data-last-responsive="true" class="table1 responsive-hide" height="15" align="center" valign="top">
							...
							<a href="<?php echo isset($this->vars['U_SEARCH']) ? $this->vars['U_SEARCH'] : $this->lang('U_SEARCH'); ?>" title="<?php echo isset($this->vars['L_SEARCH']) ? $this->vars['L_SEARCH'] : $this->lang('L_SEARCH'); ?>" role="menuitem" class="mainmenu">				
								<i class="icon ion-ios-search fa-fw" aria-hidden="true"></i>
							</a>
							</span>
						</td>
						<?php } ?>
						...
						<td data-last-responsive="true" class="table1 responsive-hide" height="15" align="center" valign="top">
							<span class="mainmenu">
							<a href="<?php echo isset($this->vars['U_MEMBERLIST']) ? $this->vars['U_MEMBERLIST'] : $this->lang('U_MEMBERLIST'); ?>" title="<?php echo isset($this->vars['L_MEMBERLIST']) ? $this->vars['L_MEMBERLIST'] : $this->lang('L_MEMBERLIST'); ?>" role="menuitem" class="mainmenu">								<i class="icon ion-ios-list-box fa-fw" aria-hidden="true"></i>
							</a>
							</span>
						</td>
						<?php } ?>
						...
						<td data-last-responsive="true" class="table1" height="15" align="center" valign="top">
							...
							<a href="<?php echo isset($this->vars['U_PROFILE']) ? $this->vars['U_PROFILE'] : $this->lang('U_PROFILE'); ?>" title="<?php echo isset($this->vars['L_PROFILE']) ? $this->vars['L_PROFILE'] : $this->lang('L_PROFILE'); ?>" role="menuitem" class="mainmenu">
								<i class="icon ion-md-man fa-fw" aria-hidden="true"></i>
							</a>
							</span>
						</td>
						<?php } ?>
						...
						<td data-last-responsive="true" class="table1" height="15" align="center" valign="top">
							...
							<a href="<?php echo isset($this->vars['U_PRIVATEMSGS']) ? $this->vars['U_PRIVATEMSGS'] : $this->lang('U_PRIVATEMSGS'); ?>" title="<?php echo isset($this->vars['L_PRIVATE_MESSAGES']) ? $this->vars['L_PRIVATE_MESSAGES'] : $this->lang('L_PRIVATE_MESSAGES'); ?>" class="mainmenu" role="menuitem">
								<i class="icon ion-ios-notifications fa-fw" aria-hidden="true"></i>
							</a>
							</span>
						</td>						
						<?php } ?>
						...
						<td data-last-responsive="true" class="table1 responsive-hide" height="15" align="center" valign="top">
							...
							<a href="<?php echo isset($this->vars['U_LOGIN_LOGOUT']) ? $this->vars['U_LOGIN_LOGOUT'] : $this->lang('U_LOGIN_LOGOUT'); ?>" title="<?php echo isset($this->vars['L_LOGIN_LOGOUT']) ? $this->vars['L_LOGIN_LOGOUT'] : $this->lang('L_LOGIN_LOGOUT'); ?>" class="mainmenu" role="menuitem">
								<i class="icon ion-ios-log-in fa-fw" aria-hidden="true"></i>
							</a>							
							</span>
						</td>
						<?php } else { ?>
						<td data-last-responsive="true" class="table1 responsive-hide" height="15" align="center" valign="top">
							<span class="mainmenu">
							<a href="<?php echo isset($this->vars['U_LOGIN_LOGOUT']) ? $this->vars['U_LOGIN_LOGOUT'] : $this->lang('U_LOGIN_LOGOUT'); ?>" title="<?php echo isset($this->vars['L_LOGIN_LOGOUT']) ? $this->vars['L_LOGIN_LOGOUT'] : $this->lang('L_LOGIN_LOGOUT'); ?>" class="mainmenu" role="menuitem">
								<i class="icon ion-ios-log-out fa-fw" aria-hidden="true"></i>
							</a>							
							</span>
						</td>						
						<?php } ?>						
						...
						<td data-last-responsive="true" class="table1 responsive-hide" height="15" align="center" valign="top">
							...
							<a href="<?php echo isset($this->vars['U_REGISTER']) ? $this->vars['U_REGISTER'] : $this->lang('U_REGISTER'); ?>" title="<?php echo isset($this->vars['L_REGISTER']) ? $this->vars['L_REGISTER'] : $this->lang('L_REGISTER'); ?>" class="mainmenu" role="menuitem">
								<img src="<?php echo isset($this->vars['T_THEME_PATH']) ? $this->vars['T_THEME_PATH'] : $this->lang('T_THEME_PATH'); ?>/images/icon_mini_register.gif" border="0" alt="<?php echo isset($this->vars['L_REGISTER']) ? $this->vars['L_REGISTER'] : $this->lang('L_REGISTER'); ?>" hspace="3" />
							</a>
							</span>
						</td>
						&nbsp;
					...
					<tr class="bg2">
						...
						<?php if ($this->vars['S_NOTIFICATIONS_DISPLAY']) {  ?>
							<div class="dropdown-container dropdown-<?php echo isset($this->vars['S_CONTENT_FLOW_END']) ? $this->vars['S_CONTENT_FLOW_END'] : $this->lang('S_CONTENT_FLOW_END'); ?> rightside" data-skip-responsive="true">
								...
								<?php  $this->set_filename('xs_include_544903b4fc1c30402d47bcc83f1d9f73', 'notification_dropdown.html', true);  $this->pparse('xs_include_544903b4fc1c30402d47bcc83f1d9f73');  ?>
							</div>
						<?php } ?>
...
<div id="wrapcentre wrap" class="wrap">
	...
	<?php  $this->set_filename('xs_include_5c13c9d80c279a016cba78af92551d5f', 'breadcrumbs.html', true);  $this->pparse('xs_include_5c13c9d80c279a016cba78af92551d5f');  ?>
