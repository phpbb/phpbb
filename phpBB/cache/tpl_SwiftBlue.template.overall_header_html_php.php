...
// eXtreme Styles mod cache. Generated on Fri, 27 Jul 2018 16:44:46 +0000 (time=1532709886)
					...
					<tr class="bg2">
						...
						<?php if ($this->vars['S_NOTIFICATIONS_DISPLAY']) {  ?>
							<div class="dropdown-container dropdown-<?php echo isset($this->vars['S_CONTENT_FLOW_END']) ? $this->vars['S_CONTENT_FLOW_END'] : $this->lang('S_CONTENT_FLOW_END'); ?> rightside" data-skip-responsive="true">
								...
								<?php  $this->set_filename('xs_include_1e9cb38c1cfc59c6c24f6d04f40619ee', 'notification_dropdown.html', true);  $this->pparse('xs_include_1e9cb38c1cfc59c6c24f6d04f40619ee');  ?>
							</div>
						<?php } ?>
...
<div id="wrapcentre wrap" class="wrap">
	...
	<?php  $this->set_filename('xs_include_55a92a6b2618ade6efa02a860382af2b', 'breadcrumbs.html', true);  $this->pparse('xs_include_55a92a6b2618ade6efa02a860382af2b');  ?>
