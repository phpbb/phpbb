...
// eXtreme Styles mod cache. Generated on Wed, 26 Sep 2018 03:12:00 +0000 (time=1537931520)
...
<?php } ?>
	<?php  $this->set_filename('xs_include_545bcd209e76cf5dfe87bdedc6e3370a', 'forumlist_body.html', true);  $this->pparse('xs_include_545bcd209e76cf5dfe87bdedc6e3370a');  ?>
<?php } ?>
...
<?php if ($this->vars['S_DISPLAY_POST_INFO'] || $this->vars['PAGINATION'] || $this->vars['TOTAL_POSTS'] || $this->vars['TOTAL_TOPICS']) {  ?>
	...
	<div class="pagination">
		...
		<?php if ($this->vars['PAGINATION']) {  ?>
			<?php  $this->set_filename('xs_include_d6e90beee65827304daef11df5b71432', 'pagination.html', true);  $this->pparse('xs_include_d6e90beee65827304daef11df5b71432');  ?>
		<?php } else { ?>
...
<?php if ($this->vars['S_HAS_SUBFORUM'] && ! $this->vars['S_DISPLAY_ACTIVE']) {  ?>
	<div class="action-bar bottom">
		...
		<div class="pagination">
			...
			<?php echo isset($this->vars['TOTAL_TOPICS']) ? $this->vars['TOTAL_TOPICS'] : $this->lang('TOTAL_TOPICS'); ?>
			<?php if ($this->vars['PAGINATION']) {  ?>
				<?php  $this->set_filename('xs_include_75f78979a14d961502ed3e1f99d4945c', 'pagination.html', true);  $this->pparse('xs_include_75f78979a14d961502ed3e1f99d4945c');  ?>
			<?php } else { ?>
				 &bull; <?php echo isset($this->vars['PAGE_NUMBER']) ? $this->vars['PAGE_NUMBER'] : $this->lang('PAGE_NUMBER'); ?>
			<?php } ?>
		</div>
...
<?php  $this->set_filename('xs_include_f77c8dc9aa5dfcf9ae6c37cad2a8402b', 'jumpbox.html', true);  $this->pparse('xs_include_f77c8dc9aa5dfcf9ae6c37cad2a8402b');  ?>
