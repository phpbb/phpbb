...
<!-- link rel="stylesheet" href="<?php echo isset($this->vars['U_PHPBB_ROOT_PATH']) ? $this->vars['U_PHPBB_ROOT_PATH'] : $this->lang('U_PHPBB_ROOT_PATH'); ?><?php echo isset($this->vars['TEMPLATE_ROOT_PATH']) ? $this->vars['TEMPLATE_ROOT_PATH'] : $this->lang('TEMPLATE_ROOT_PATH'); ?><?php echo isset($this->vars['T_HEAD_STYLESHEET']) ? $this->vars['T_HEAD_STYLESHEET'] : $this->lang('T_HEAD_STYLESHEET'); ?>" type="text/css" -->
<style type="text/css">
<!--
...
td.rowpic {
		...
		background-image: url(<?php echo isset($this->vars['U_PHPBB_ROOT_PATH']) ? $this->vars['U_PHPBB_ROOT_PATH'] : $this->lang('U_PHPBB_ROOT_PATH'); ?><?php echo isset($this->vars['TEMPLATE_ROOT_PATH']) ? $this->vars['TEMPLATE_ROOT_PATH'] : $this->lang('TEMPLATE_ROOT_PATH'); ?>images/<?php echo isset($this->vars['T_TH_CLASS3']) ? $this->vars['T_TH_CLASS3'] : $this->lang('T_TH_CLASS3'); ?>);
...
th	{
	...
	background-image: url(<?php echo isset($this->vars['U_PHPBB_ROOT_PATH']) ? $this->vars['U_PHPBB_ROOT_PATH'] : $this->lang('U_PHPBB_ROOT_PATH'); ?><?php echo isset($this->vars['TEMPLATE_ROOT_PATH']) ? $this->vars['TEMPLATE_ROOT_PATH'] : $this->lang('TEMPLATE_ROOT_PATH'); ?>images/<?php echo isset($this->vars['T_TH_CLASS2']) ? $this->vars['T_TH_CLASS2'] : $this->lang('T_TH_CLASS2'); ?>);
}

td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom {
			background-image: url(<?php echo isset($this->vars['U_PHPBB_ROOT_PATH']) ? $this->vars['U_PHPBB_ROOT_PATH'] : $this->lang('U_PHPBB_ROOT_PATH'); ?><?php echo isset($this->vars['TEMPLATE_ROOT_PATH']) ? $this->vars['TEMPLATE_ROOT_PATH'] : $this->lang('TEMPLATE_ROOT_PATH'); ?>images/<?php echo isset($this->vars['T_TH_CLASS1']) ? $this->vars['T_TH_CLASS1'] : $this->lang('T_TH_CLASS1'); ?>);
...
@import url("<?php echo isset($this->vars['U_PHPBB_ROOT_PATH']) ? $this->vars['U_PHPBB_ROOT_PATH'] : $this->lang('U_PHPBB_ROOT_PATH'); ?><?php echo isset($this->vars['TEMPLATE_ROOT_PATH']) ? $this->vars['TEMPLATE_ROOT_PATH'] : $this->lang('TEMPLATE_ROOT_PATH'); ?>formIE.css"); 
-->
</style>
...
<link rel="stylesheet" href="<?php echo isset($this->vars['U_PORTAL_ROOT_PATH']) ? $this->vars['U_PORTAL_ROOT_PATH'] : $this->lang('U_PORTAL_ROOT_PATH'); ?><?php echo isset($this->vars['TEMPLATE_ROOT_PATH']) ? $this->vars['TEMPLATE_ROOT_PATH'] : $this->lang('TEMPLATE_ROOT_PATH'); ?>admin/admin.css" type="text/css" >
<!-- Optionally, redefine some defintions for gecko browsers -->
<?php if ($this->vars['GECKO']) {  ?>
<!-- Optionally, redefine some defintions for gecko browsers -->
<link rel="stylesheet" href="<?php echo isset($this->vars['U_PORTAL_ROOT_PATH']) ? $this->vars['U_PORTAL_ROOT_PATH'] : $this->lang('U_PORTAL_ROOT_PATH'); ?><?php echo isset($this->vars['TEMPLATE_ROOT_PATH']) ? $this->vars['TEMPLATE_ROOT_PATH'] : $this->lang('TEMPLATE_ROOT_PATH'); ?><?php echo isset($this->vars['T_GECKO_STYLESHEET']) ? $this->vars['T_GECKO_STYLESHEET'] : $this->lang('T_GECKO_STYLESHEET'); ?>" type="text/css" >
<?php } ?>
