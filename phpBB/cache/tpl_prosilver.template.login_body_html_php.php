...
// eXtreme Styles mod cache. Generated on Tue, 07 Aug 2018 01:38:55 +0000 (time=1533605935)
...
<div class="panel">
	...
	<div class="content">
		...
		<?php if ($this->vars['CAPTCHA_TEMPLATE'] && $this->vars['S_CONFIRM_CODE']) {  ?>
			...
			<?php  $this->set_filename('xs_include_83ba34ec62cf039994668f6fc15dea5a', '{CAPTCHA_TEMPLATE}', true);  $this->pparse('xs_include_83ba34ec62cf039994668f6fc15dea5a');  ?>
		<?php } ?>
	...
	<?php if (! $this->vars['S_ADMIN_AUTH'] && $this->vars['PROVIDER_TEMPLATE_FILE']) {  ?>
		<?php  $this->set_filename('xs_include_4d64e4fb45679260af2af4850752e3cb', '{PROVIDER_TEMPLATE_FILE}', true);  $this->pparse('xs_include_4d64e4fb45679260af2af4850752e3cb');  ?>
	<?php } ?>
	</div>
</div>
