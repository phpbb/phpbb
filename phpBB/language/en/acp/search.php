...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_SPHINX_CONFIG_PATH_EXPLAIN'	=> 'You should put the sphinx.conf file in this directory. This config directory should be outside the web accessable directories.',
