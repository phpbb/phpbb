...
$lang = array_merge($lang, array(
	...
	'LIMIT_DELETE_OWN_POST_TO_NEW_EXPLAIN' => 'Choose whether normal users can delete their own posts at any time, or only when trying to delete the last post in a topic. The time limit on deleting a new post still applies regardless.',
