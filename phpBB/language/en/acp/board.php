...
$lang = array_merge($lang, array(
	...
	'LOGIN_COOLDOWN_MAX'			=> 'Maximum login cooldown time',
	'LOGIN_COOLDOWN_MAX_EXPLAIN'	=> 'The login cooldown time will not grow beyond this value.',
	'LOGIN_COOLDOWN_MIN'			=> 'Minimum login cooldown time',
	'LOGIN_COOLDOWN_MIN_EXPLAIN'	=> 'Once the maximum number of login attempts for a username or IP address is exceeded, further login attempts are rejected for this period after each failed attempt. The cooldown time grows by this value for every further failed attempt. The cooldown is independent of the CAPTCHA, so it also protects boards whose CAPTCHA has been broken. Enter 0 to disable the login cooldown.',
