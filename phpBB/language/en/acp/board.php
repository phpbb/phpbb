...
$lang = array_merge($lang, array(
	...
	'COOKIE_DOMAIN_EXPLAIN'		=> 'In most cases the cookie domain is optional. Leave it blank if you are unsure.<br /><br /> In the case where you have a board integrated with other software or have multiple domains, then to determine the cookie domain you need to do the following. If you have something like <em>example.com</em> and <em>forums.example.com</em>, or perhaps <em>forums.example.com</em> and <em>blog.example.com</em>. Remove the subdomains until you find the common domain, <em>example.com</em>. Now add a dot in front of the common domain and you would enter .example.com (note the dot at the beginning).',
