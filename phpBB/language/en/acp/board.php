...
$lang = array_merge($lang, array(
	...
	'SERVICE_MODUS'					=> 'Board offline<br />Maintenance mode:&nbsp;Board index displayed&nbsp;&nbsp;~&nbsp;Disable board:&nbsp;Board index hidden<br /><span style="color:#FF0000">Only one mode select!</span> ',
	'SERVICE_BOARD'					=> 'Maintenance mode',
	'SERVICE_BOARD_EXPLAIN'					=> 'This turns the board for all users in maintenance mode.You can also enter a short (255 character) message to display if you wish.<br /><span style="color:#FF0000">If you are not typing here the user not informed!</span>',
