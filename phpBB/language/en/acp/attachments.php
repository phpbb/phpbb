...
$lang = array_merge($lang, array(
	'ACP_ATTACHMENT_SETTINGS_EXPLAIN'	=> 'Here you can configure the main settings for attachments. The associated special categories settings that control which file types may be attached are found on the "Postings" tab under "Attachments".',
