...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'This setting overrides the per-user folder message limit. The maximum for all groups of the user is used to determinate the actual value.<br />Set this value to 0 to overwrite the setting for all users of this group with the board-wide setting.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'The maximum number of allowed recipients in a private message.  The maximum for all groups of the user is used to determinate the actual value.<br />Set this value to 0 to overwrite the setting for all users of this group with the board-wide setting.',
