...
$lang = array_merge($lang, array(
	...
	'REVISION_LIMIT_EXPLAIN'					=> 'Set to 0 for unlimited revisions per post. Once revision threshold is reached, the oldest revision will be removed to make room for the new one.',
