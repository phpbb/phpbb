...
$lang = array_merge($lang, array(
	...
	'ERROR'								=> 'Error',
	'EXCEPTION_AT_METHOD'				=> 'at %1$s%2$s%3$s(%4$s)',
	'EXCEPTION_IN_LINE'					=> 'in %1$s line %2$d',
	'EXCEPTION_OCCURRED'				=> 'An exception occurred while trying to load this page. Please try to refresh this page and if the problem persists, please contact the %1$sBoard Administrator%2$s.',
	'EXCEPTION_OCCURRED_AJAX'			=> 'An exception occurred during the execution of the request. Please try again and if the problem persists, please contact the Board Administrator: %1$s',
	'EXCEPTION_TITLE'					=> 'Oops, an error occurred',
	'EXCEPTION_WHILE_HANDLING'			=> 'Exception thrown while handling an exception (%1$s: %2$s)',
