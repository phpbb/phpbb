...
$lang = array_merge($lang, array(
	...
	'BBCODE_HELP_ATTACHMENT'				=> 'Inline uploaded attachment: [attachment=]filename.ext[/attachment]',
	'BBCODE_HELP_HELP_B'				=> 'Bold text: [b]text[/b]',
	'BBCODE_HELP_CODE'				=> 'Code display: [code]code[/code]',
	'BBCODE_HELP_FLASH'				=> 'Flash: [flash=width,height]http://url[/flash]',
	'BBCODE_HELP_SIZE'				=> 'Font size: [size=85]small text[/size]',
	'BBCODE_IS_OFF'				=> '%sBBCode%s is <em>OFF</em>',
	'BBCODE_IS_ON'				=> '%sBBCode%s is <em>ON</em>',
	'BBCODE_HELP_I'				=> 'Italic text: [i]text[/i]',
	'BBCODE_HELP_LIST'				=> 'List: [list][*]text[/list]',
	'BBCODE_HELP_*'		=> 'List item: [*]text',
	'BBCODE_HELP_IMG'				=> 'Insert image: [img]http://image_url[/img]',
	'BBCODE_HELP_QUOTE'				=> 'Quote text: [quote]text[/quote]',
	'BBCODE_HELP_COLOR'				=> 'Font colour: [color=red]text[/color] or [color=#FF0000]text[/color]',
	'BBCODE_HELP_U'				=> 'Underline text: [u]text[/u]',
	'BBCODE_HELP_URL'				=> 'Insert URL: [url]http://url[/url] or [url=http://url]URL text[/url]',
