...
$faq[] = array("O que é BBCode?", "BBCode é uma implementação especial de HTML. A possibilidade em poder usar BBCode nas suas mensagens é determinada pelo Administrador dos fóruns. Adicionalmente, você pode poderá desligar o BBCode em cada mensagem assinalando <b>Desactivar BBCode nesta mensagem</b> abaixo da caixa principal de cada mensagem. BBCode por si mesmo é similar em estilo ao HTML, as etiquetas (tags) são incluidas em parêntesis rectos [ and ] em vez de &lt; e &gt; proporcionando um maior controle do que haja a controlar bem como a sua apresentação. A tarefa de adicionar BBCode ás suas mensagen é facilitada pelo uso de um painel colocado imediatamente acima á caixa principal das mensagens, dependendo do modelo de phpBB em uso, onde pode escolher e aplicar os vários itens consoante o código que pretenda aplicar. Apesar da existência desse painel este decerto que este guia lhe vai ser útil.");
...
Como em todas as etiquetas de BBCode pode misturar URLs com quaisquer outras etiquetas, como por exemplo <b>[img][/img]</b> (ver a próxima), <b>[b][/b]</b>, etc. Em relação ao formato das etiquetas está totalmente dependente de si assegurar a ordem correcta de início e fecho, por exemplo:<br /><br /><b>[url=http://www.phpbb.com/][img]</b>http://www.phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />isto <u>não é</u> correcto, o que pode conduzir á sua mensagem ser removida por algum moderador ou Administrador. Como tal tenha cuidado.");
