...
$faq[] = array("Varför behöver jag registera mig?", "Det är inte säkert att du behöver, det är upp till forum administratören om du behöver registrera dig för att skriva ett meddelande. Dock så ger registreringen dig ytterligare funktioner som inte är tillgängliga för gäster, till exempel avatar bilder, privata meddelanden, e-post till andra användare, prenumeration av användargrupper, etc. Det tar endast några sekunder att registrera sig så det är att rekommendera.");
