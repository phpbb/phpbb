...
$lang['Styles_addnew_explain'] = "Этот список содержит все цветовые схемы, подходящие к имеющимся у вас шаблонам. Элементы этого списка НЕ БЫЛИ пока установлены в базу phpBB. Для установки схемы просто нажмите 'Установить' рядом с выбранным элементом";
