...
$lang['Inbox_size'] = "Ваша папка «Входящие» заполнена на %d%%"; // eg. Your Inbox is 50% full
$lang['Sentbox_size'] = "Ваша папка «Отправленные» заполнена на %d%%"; 
$lang['Savebox_size'] = "Ваша папка «Сохраненные» заполнена на %d%%"; 
...
$lang['tz']['-1'] = "(GMT -1:00) Азорские о-ва, о-ва Зелёного Мыса";
...
$lang['tz']['2'] = "(GMT +2:00) Калининград, Киев, Минск, Рига, Таллин, Варшава";
