...
$lang['Click_view_message'] = "点击 %s这里%s 阅读你的帖子";
...
$lang['Mod_online_color'] = "%s版面管理员%s";
...
$lang['Search_your_posts'] = "阅读你发表的帖子";
$lang['Search_unanswered'] = "阅读尚未回答的帖子";

$lang['Register'] = "注册";
$lang['Profile'] = "个人资料";
$lang['Edit_profile'] = "编辑你的个人资料";
$lang['Search'] = "搜索";
...
// Login
//
$lang['Enter_password'] = "请输入您的用户名和密码登入";
$lang['Login'] = "登入";
$lang['Logout'] = "注销";

$lang['Forgotten_password'] = "我忘记了密码!";

$lang['Log_me_in'] = "浏览时自动登入";
...
$lang['Forum_not_exist'] = "你选择的论坛不存在";
$lang['Reached_on_error'] = "你选择的论坛出错了";

$lang['Display_topics'] = "显示以前的帖子";
$lang['All_Topics'] = "所有的帖子";

$lang['Topic_Announcement'] = "<b>通告:</b>";
...
$lang['Rules_post_can'] = "你<b>可以</b>发布新主题";
$lang['Rules_post_cannot'] = "你<b>不能</b>发布新主题";
$lang['Rules_reply_can'] = "你<b>可以</b>在这个论坛回复主题";
$lang['Rules_reply_cannot'] = "你<b>不能</b>在这个论坛回复主题";
$lang['Rules_edit_can'] = "你<b>可以</b>在这个论坛编辑自己的帖子";
$lang['Rules_edit_cannot'] = "你<b>不能</b>在这个论坛编辑自己的帖子";
$lang['Rules_delete_can'] = "你<b>可以</b>在这个论坛删除自己的帖子";
$lang['Rules_delete_cannot'] = "你<b>不能</b>在这个论坛删除自己的帖子";
$lang['Rules_vote_can'] = "你<b>可以</b>在这个论坛发表投票";
$lang['Rules_vote_cannot'] = "你<b>不能</b>在这个论坛发表投票";
$lang['Rules_moderate'] = "你<b>可以</b>%s管理这个论坛%s"; // %s replaced by a href links, do not remove! 
...
$lang['Topic_post_not_exist'] = "你选择的主题不存在";
...
$lang['Post_Announcement'] = "声明";
$lang['Post_Sticky'] = "置顶";
$lang['Post_Normal'] = "普通";

$lang['Confirm_delete'] = "你确定要删除这个主题吗?";
$lang['Confirm_delete_poll'] = "你确定要删除这个投票吗?";

$lang['Flood_Error'] = "你不能在发贴后马上发表新贴，请过一会再试.";
$lang['Empty_subject'] = "你发表的帖子必须有一个主题.";
$lang['Empty_message'] = "你发表的帖子必须有内容.";
$lang['Forum_locked'] = "这个论坛已经被锁定,你不能发表,回复或者编辑帖子.";
$lang['Topic_locked'] = "这个论题已经被锁定,你不能发表,回复或者编辑帖子.";
$lang['No_post_id'] = "请选择你要编辑的主题";
$lang['No_topic_id'] = "请选择你要回复的主题";
$lang['No_valid_mode'] = "你只可以选择发表,回复或者引用帖子,请后退重试.";
$lang['No_such_post'] = "没有这个帖子,请后退重试.";
$lang['Edit_own_posts'] = "对不起你只可以编辑自己的帖子.";
$lang['Delete_own_posts'] = "对不起你只可以删除自己的帖子.";
$lang['Cannot_delete_replied'] = "对不起你可能不可以删除已经被回复的帖子.";
$lang['Cannot_delete_poll'] = "对不起你不可以删除正处于活动状态的投票.";
$lang['Empty_poll_title'] = "你必须给你发表的投票建立一个主题.";
$lang['To_few_poll_options'] = "你必须要建立至少两个投票的选项.";
$lang['To_many_poll_options'] = "你选择建立太多的投票的选项";
$lang['Post_has_no_poll'] = "这个主题没有建立投票";

$lang['Add_poll'] = "建立一个投票";
$lang['Add_poll_explain'] = "如果你不想建立投票请不要填写这个选项.";
...
$lang['Stored'] = "你的帖子已经成功的储存";
$lang['Deleted'] = "你的帖子已经成功的被删除";
$lang['Poll_delete'] = "你建立的投票已经成功的被删除";
$lang['Vote_cast'] = "你的选票已经投出";
...
$lang['bbcode_c_help'] = "显示code : [code]code[/code]  (alt+c)";
...
$lang['bbcode_s_help'] = "字体颜色: [color=red]text[/color]  提示: 你也可以使用如 color=#FF0000 这样的html语句";
...
$lang['Login_check_pm'] = "登入查看您的站内信件";
...
$lang['Cannot_send_privmsg'] = "对不起论坛管理员已经禁止你发送站内信件";
$lang['No_to_user'] = "您必须指定站内信件发送的对象";
$lang['No_such_user'] = "对不起这个用户不存在";

$lang['Message_sent'] = "你的站内信件发送成功";

$lang['Click_return_inbox'] = "点击 %s这里%s 返回你的收件箱";
...
$lang['Preferences'] = "选项";
$lang['Items_required'] = "带 * 的项目是必须选择的";
$lang['Registration_info'] = "注册信息";
$lang['Profile_info'] = "个人资料";
$lang['Profile_info_warn'] = "这个信息将被公开";
...
$lang['Always_notify_explain'] = "当有人回复我的帖子时发送一封电子邮件提醒我.这个选项可以被更改当您发表主题时";
...
$lang['Signature'] = "个人签名";
$lang['Signature_explain'] = "您填写的个人签名可以发表在您的帖子后.个人签名有%d个字符的限制";
$lang['Public_view_email'] = "总是现实我的电子邮件地址";
...
$lang['Account_added'] = "感谢您的注册,您的账户已经被建立.您现在就可以使用您的用户名和密码登入";
$lang['Account_inactive'] = "感谢您的注册,您的账户已经被建立.但是本论坛需要激活账户.请察看您的电子邮件理解更多的信息.";
...
$lang['Flood_email_limit'] = "你不能现在发送其他的电子邮件,请过一会再试.";
$lang['Recipient'] = "收信人";
...
$lang['Could_not_anon_user'] = "您不能建立匿名的团队成员";
...
$lang['Sorry_auth_announce'] = "对不起只有 %s 可以在这个论坛发表申明";
...
$lang['Auth_Anonymous_users'] = "<b>匿名用户</b>";
...
$lang['You_been_banned'] = "这个论坛已经禁止你访问<br />请联络论坛管理员了解细节";
...
$lang['tz']['-2'] = "(GMT -2:00 hours) 中大西洋, 亚森松岛, 圣赫勒拿";
