 ...
 *
 *     $Id: lang_bbcode.php,v 1.1 2010/10/10 15:09:43 orynider Exp $
 *
 *
 ***************************************************************************/
...
$faq[] = array("Ce este codul BB?", "Codul BB este o implementare specialã a codului HTML. Dacã puteþi folosi codul BB sau nu în mesajele dumneavoastrã este alegerea administratorului. În plus, puteþi dezactiva codul BB de la mesaj la mesaj din formularul de publicare. Codul BB este similar cu HTML-ul, balizele (tag-urile) sunt scrise între paranteze pãtrate [ ºi ] decât între &lt; ºi &gt; ºi oferã un control mai bun asupra ce ºi cum este afiºat. În funcþie de ºablonul pe care îl folosiþi puteþi descoperi cã adãugarea de cod BB la mesajele dumneavoastrã este mai uºoarã printr-un set de butoane. Chiar ºi aºa probabil cã veþi gãsi acest ghid folositor.");
