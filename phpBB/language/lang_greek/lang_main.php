...
$lang['Click_return_modcp'] = "Πατήστε %sΕδώ%s για να επιστρέψετε στον πίνακα ελέγχου του Διαμεσολαβητή";
...
$lang['Rules_moderate'] = "<b>Μπορείτε</b> να είσθε %sΔιαμεσολαβητής σ'αυτή τη Δ.Συζήτηση%s"; // %s replaced by a href links, do not remove! 
...
$lang['Delete_post'] = "Διαγραφή αυτού του μηνύματος";
...
$lang['No_post_mode'] = "Δεν προσδιορίσθηκε η μέθοδος της Δημοσίευσης";
...
$lang['Announce_and_sticky'] = "Δεν μπορείτε να δημοσιεύσετε ένα μήνυμα όταν έχει χαρακτηρισθεί ως ανακοίνωση και ως σημείωση ταυτόχρονα";
...
$lang['No_post_id'] = "Πρέπει να επιλέξετε μια Δημοσίευση για να την επεξεργασθείτε";
...
$lang['BBCode_is_ON'] = "BBCode  <u>Ενεργό</u>";
$lang['BBCode_is_OFF'] = "BBCode  <u>Ανενεργό</u>";
...
$lang['Re'] = "Απ"; // Re as in 'Response to'
...
$lang['Search_user_posts'] = "Αναζήτηση δημοσιεύσεων από χρήστη";
...
$lang['Sorry_banned_or_taken_email'] = "Συγνώμη αλλά η email διεύθυνση που εισαγάγατε έχει απαγορευθεί, έχει καταχωρηθεί από άλλον χρήστη ή είναι μη έγκυρη. Παρακαλώ δοκιμάστε μία εναλλακτική διεύθυνση. Εάν αντιμετωπίσετε το ίδιο πρόβλημα επικοινωνήστε με τον διαχειριστή του συστήματος για συμβουλή";
...
$lang['Upload_Avatar_file'] = "Μεταφόρτωση Άβαταρ από τον υπολογιστή σας";
$lang['Upload_Avatar_URL'] = "Μεταφόρτωση Άβαταρ από URL";
$lang['Upload_Avatar_URL_explain'] = "Εισαγωγή URL η οποία περιέχει το Άβαταρ αρχείο, θα γίνει μεταφόρτωση στον εξυπηρετητή μας.";
...
$lang['Group_Moderator'] = "Διαμεσολαβητής Ομάδας";
...
$lang['Current_memberships'] = "Τρέχοντες ιδιότητες μελών";
...
$lang["Group_joined"] = "Εγγραφήκατε επιτυχώς σ' αυτή τη ομάδα<br/>Μόλις εγκριθεί η συμμετοχή σας στην ομάδα αυτή θα ειδοποιηθείτε από τον διαμεσολαβητή ομάδας";
...
$lang['Not_group_moderator'] = "Δεν είσθε διαμεσολαβητής αυτής της ομάδας και για αυτό δεν μπορείτε να ολοκληρώσετε αυτήν την πράξη.";
...
$lang['characters_posts'] = "χαραχτήρων δημοσιεύματος";
...
$lang['Display_results'] = "Εμφάνισε τα αποτελάσματα κατά:";
...
//
$lang['Mod_CP'] = "Πίνακας ελέγχου διαμεσολαβητή";
...
$lang['-10'] = "HST (Χαβάι)";
$lang['-9'] = "GMT - 9 Ώρες";
$lang['-8'] = "PST (ΗΠΑ/Καναδάς)";
$lang['-7'] = "MST (ΗΠΑ/Καναδάς)";
$lang['-6'] = "CST (ΗΠΑ/Καναδάς)";
$lang['-5'] = "EST (ΗΠΑ/Καναδάς)";
$lang['-4'] = "GMT - 4 Ώρες";
$lang['-3.5'] = "GMT - 3.5 Ώρες";
$lang['-3'] = "GMT - 3 Ώρες";
$lang['-2'] = "Μέσος-Ατλαντικός";
$lang['-1'] = "GMT - 1 Ώρα";
$lang['0'] = "GMT";
$lang['1'] = "CET (Ευρώπη)";
$lang['2'] = "EET (Ευρώπη)";
...
$lang['6'] = "GMT + 6 Ώρες";
$lang['7'] = "GMT + 7 Ώρες";
$lang['8'] = "WST (Αυστραλία)";
$lang['9'] = "GMT + 9 Ώρες";
$lang['9.5'] = "CST (Αυστραλία)";
$lang['10'] = "EST (Αυστραλία)";
$lang['11'] = "GMT + 11 Ώρες";
$lang['12'] = "GMT + 12 Ώρες";
