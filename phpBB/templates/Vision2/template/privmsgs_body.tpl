		...
		<tr> 
		  <td colspan="3" width="175" class="row2">
			<table cellspacing="0" cellpadding="1" border="0">
			  <tr> 
				<td bgcolor="{T_TD_COLOR2}"><img src="templates/Vision2/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			  </tr>
			</table>
		  </td>
		</tr>
...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
	  <td width="5%" height="25" class="row3" nowrap="nowrap" align="center"><span class="fontrow3">&nbsp;{L_FLAG}&nbsp;</span></th>
	  <td width="55%" class="row3" nowrap="nowrap" align="center"><span class="fontrow3">&nbsp;{L_SUBJECT}&nbsp;</span></th>
	  <td width="20%" class="row3" nowrap="nowrap" align="center"><span class="fontrow3">&nbsp;{L_FROM_OR_TO}&nbsp;</span></th>
	  <td width="15%" class="row3" nowrap="nowrap" align="center"><span class="fontrow3">&nbsp;{L_DATE}&nbsp;</span></th>
	  <td width="5%" class="row3" nowrap="nowrap" align="center"><span class="fontrow3">&nbsp;{L_MARK}&nbsp;</span></th>
	</tr>
	<!-- BEGIN listrow -->
	<tr> 
	  <td width="5%" align="center" valign="middle"><img src="{listrow.PRIVMSG_FOLDER_IMG}" width="19" height="18" alt="{listrow.L_PRIVMSG_FOLDER_ALT}" title="{listrow.L_PRIVMSG_FOLDER_ALT}" /></td>
	  <td width="55%" valign="middle"><span class="topictitle">&nbsp;<a href="{listrow.U_READ}" class="topictitle">{listrow.SUBJECT}</a></span></td>
	  <td width="20%" valign="middle" align="center"><span class="name">&nbsp;<a href="{listrow.U_FROM_USER_PROFILE}" class="name">{listrow.FROM}</a></span></td>
	  <td width="15%" align="center" valign="middle"><span class="postdetails">{listrow.DATE}</span></td>
	  <td width="5%" align="center" valign="middle"><span class="postdetails"> 
