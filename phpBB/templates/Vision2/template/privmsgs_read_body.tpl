...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td width="100%" colspan="2"><span class="genmed">{MESSAGE_FROM}</span></td>
	</tr>
	<tr> 
	  <td class="row1"><span class="genmed">{L_TO}:</span></td>
	  <td width="100%" colspan="2"><span class="genmed">{MESSAGE_TO}</span></td>
	</tr>
	<tr> 
	  <td class="row1"><span class="genmed">{L_POSTED}:</span></td>
	  <td width="100%" colspan="2"><span class="genmed">{POST_DATE}</span></td>
	</tr>
	<tr> 
	  <td class="row1"><span class="genmed">{L_SUBJECT}:</span></td>
	  <td width="100%"><span class="genmed">{POST_SUBJECT}</span></td>
	  <td nowrap="nowrap" align="right"> {QUOTE_PM_IMG} {EDIT_PM_IMG}</td>
	</tr>
	<tr> 
	  <td valign="top" colspan="3"><span class="postbody">{MESSAGE}</span></td>
	</tr>
	<tr> 
