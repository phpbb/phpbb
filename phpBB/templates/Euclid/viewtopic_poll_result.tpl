						...
						<td align="center"><table cellspacing="0" cellpadding="2" border="0">
							...
							<tr>
								...
								<td><table width="{poll_option.POLL_OPTION_IMG_WIDTH}" cellspacing="0" cellpadding="0" border="0">
									<tr>
										<td width="100%" bgcolor="{poll_option.POLL_OPTION_IMG_COLOR}"><img src="{poll_option.POLL_OPTION_IMG}" width="{poll_option.POLL_OPTION_IMG_WIDTH}" height="10" alt="{poll_option.POLL_OPTION_PERCENT}" /></td>
									</tr>
								</table></td>
