...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="100%">
  <tr> 
	...
	<td align="right"> 
	  ...
	  <table width="175" cellspacing="0" cellpadding="2" border="0" class="bodyline">
		<tr> 
		...
		<tr> 
		  <td colspan="3" width="175" class="row2">
			<table cellspacing="0" cellpadding="1" border="0">
			  <tr> 
				<td bgcolor="{T_TD_COLOR2}"><img src="templates/Vision1/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			  </tr>
			</table>
		  </td>
		</tr>
