...
<tr>
        ...
        <td class="row4" align="right" style="padding-right:10px"><span class="genwhite">{L_ITEMS_REQUIRED}</span></td>
  </tr>
...
<tr>
        <td class="row4" align="left"><img src="templates/Vision1/images/cellpic_shadow_left.gif" border="0"></td>
        <td class="row4" align="right" style="padding-right:10px"><span class="genwhite">{L_PROFILE_INFO_NOTICE}</span></td>
  </tr>
	<tr> 
