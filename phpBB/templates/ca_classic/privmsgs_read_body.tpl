	...
	<tr> 
	  <td width="78%" height="28" valign="bottom" colspan="3" class="row1"> 
		...
		if ( navigator.userAgent.toLowerCase().indexOf('mozilla') != -1 && navigator.userAgent.indexOf('5.') == -1 )
			...
			document.write('<div style="position:relative"><div style="position:absolute">{ICQ_IMG}</div><div style="position:absolute;left:4px;top:-1px">{ICQ_STATUS_IMG}</div></div>');
