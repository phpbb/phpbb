...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	{POLLBOX} 
	<tr> 
	  <td class="catBottom" colspan="2" align="center" height="28"> {S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="post" class="mainoption" value="{L_SUBMIT}" />&nbsp;<input type="submit" tabindex="6" name="preview" class="mainoption" value="{L_PREVIEW}" /></td>
	</tr>
  </table>
