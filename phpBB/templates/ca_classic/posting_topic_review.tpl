...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
		<th class="catHead" width="22%" height="26">{L_AUTHOR}</th>
		<th class="catHead">{L_MESSAGE}</th>
	</tr>
	<!-- BEGIN postrow -->
	<tr>
	...
	<tr> 
		<td colspan="2" height="1" class="spaceRow"><img src="templates/ca_classic/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	 <!-- END postrow -->
</table>
<!-- BEGIN switch_inline_mode -->
