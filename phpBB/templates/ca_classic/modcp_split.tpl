  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row2" colspan="2"><span class="courier"> 
		<input type="text" size="35" style="width: 350px" maxlength="60" name="subject" class="post" />
		</span></td>
	</tr>
	<tr> 
	...
	<tr> 
	  ...
	  <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
		  <tr> 
			<td valign="middle"><img src="templates/ca_classic/images/icon_minipost.gif" width="12" height="9" alt="{L_POST}" /><span class="postdetails">{L_POSTED}: 
	...
	<tr> 
	  <td colspan="3" height="1" class="row3"><img src="templates/ca_classic/images/spacer.gif" width="1" height="1" alt="."></td>
	</tr>
	<!-- END postrow -->
	<tr> 
