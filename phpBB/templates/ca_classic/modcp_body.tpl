...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="spaceRow" colspan="5" align="center"><span class="spaceRow">{L_MOD_CP_EXPLAIN}</span></td>
	</tr>
	<tr> 
	...
	<!-- BEGIN topicrow -->
	<tr> 
	  <td class="row1" align="center" valign="middle"><img src="{topicrow.TOPIC_FOLDER_IMG}" width="18" height="18" alt="{topicrow.L_TOPIC_FOLDER_ALT}" title="{topicrow.L_TOPIC_FOLDER_ALT}" /></td>
