...
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center" background="templates/aluminoid/images/metal.gif">
	<tr> 
  ...
  <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline" background="templates/aluminoid/images/metal.gif">
	<tr> 
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2" background="templates/aluminoid/images/metal.gif">
	<tr> 
	  <td align="left" valign="middle" width="50"><a href="{U_POST_NEW_TOPIC}"><img src="{POST_IMG}" border="0" alt="{L_POST_NEW_TOPIC}" /></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="templates/aluminoid/images/metal.gif">
  <tr> 
	<td align="right">{JUMPBOX}</td>
  </tr>
</table>

<table width="100%" cellspacing="0" border="0" align="center" cellpadding="0" background="templates/aluminoid/images/metal.gif">
	<tr>
