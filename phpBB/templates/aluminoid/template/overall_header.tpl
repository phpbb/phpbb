			...
			<tr> 
				...
				<table cellspacing="0" cellpadding="2" border="0" align="right">
					<tr>
						...
						<p />
						<a href="{U_LOGIN_LOGOUT}" class="mainmenu"><img src="templates/aluminoid/images/lang_english/icon_loginout.gif" width="96" height="20" border="0" alt="{L_LOGIN_LOGOUT}" hspace="3" />{L_LOGIN_LOGOUT}</a>&nbsp;&nbsp;<a href="{U_REGISTER}" class="mainmenu"><img src="templates/aluminoid/images/lang_english/icon_register.gif" width="86" height="20" border="0" alt="{L_REGISTER}" hspace="3" />{L_REGISTER}</a></span></td>
					</tr>
				</table></td>
			</tr>
				<tr>
