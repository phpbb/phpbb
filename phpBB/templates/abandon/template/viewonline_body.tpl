...
<table width="95%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="3" height="1" class="row3"><img src="templates/abandon/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
  <tr> 
...
<table width="95%" cellspacing="2" border="0" align="center" cellpadding="2" align="center">
  <tr> 
