...
* @var	array	board_statistics		Array with the board statistics, legend and birthday list
* @since 3.1.0-a1
*/
$vars = array('page_title', 'board_statistics');
extract($phpbb_dispatcher->trigger_event('core.index_modify_page_title', compact($vars)));

// Assign index specific vars
$template->assign_vars($board_statistics);
