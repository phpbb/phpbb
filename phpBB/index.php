...
$template->assign_vars(array(
	...
	'U_MARK_FORUMS'		=> ($user->data['is_registered'] || $config['load_anon_lastread']) ? $controller_helper->route('notification.controller.mark_all_read', ['hash' => generate_link_hash('global'), 'mark_time' => time()]) : '',
