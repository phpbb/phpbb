...
$template->assign_vars(array(
	...
	'S_LOGIN_ACTION'			=> $controller_helper->route('ucp_account', ['mode' => 'login']),
	...
	'U_MCP'				=> ($auth->acl_get('m_') || $auth->acl_getf_global('m_')) ? $controller_helper->route('mcp_index', [], false, $user->session_id) : '')
);
