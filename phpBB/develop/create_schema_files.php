...
function get_schema_struct()
{
	...
	$schema_data['phpbb_forums'] = array(
		'COLUMNS'		=> array(
			...
			'forum_last_post_id_real'=> array('UINT', 0),
			'forum_last_poster_id_real'=> array('UINT', 0),
			'forum_last_post_subject_real'=> array('STEXT_UNI', ''),
			'forum_last_post_time_real'=> array('TIMESTAMP', 0),
			'forum_last_poster_name_real'=> array('VCHAR_UNI', ''),
			'forum_last_poster_colour_real'=> array('VCHAR:6', ''),
	...
	$schema_data['phpbb_topics'] = array(
		'COLUMNS'		=> array(
			...
			'topic_last_post_id_real'	=> array('UINT', 0),
			'topic_last_poster_id_real'	=> array('UINT', 0),
			'topic_last_poster_name_real'=> array('VCHAR_UNI', ''),
			'topic_last_poster_colour_real'=> array('VCHAR:6', ''),
			'topic_last_post_subject_real'=> array('STEXT_UNI', ''),
			'topic_last_post_time_real'	=> array('TIMESTAMP', 0),
