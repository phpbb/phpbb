...
class converter_index
{
	 ...
	 */
	public function __construct(\phpbb\install\converter\controller\helper $helper, $container, $nav_provider, \phpbb\language\language $language, \phpbb\template\template $template, $module, $install_config, $iohandler, $request, $phpbb_root_path, $php_ext)
	{
		$this->helper = $helper;
