...
class converter_index
{
     ...
     */
    public function __construct($container, $dbal_config,\phpbb\install\controller\helper $helper, \phpbb\language\language $language, \phpbb\template\template $template, $phpbb_root_path)
    {
        $this->helper = $helper;
