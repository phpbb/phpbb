...
class helper
{
	...
	{
		return $this->installer_config->get_converter_source_db();
	}

	public function get_destination_db()
	{
		return $this->installer_config->get_converter_destination_db();
	}

	public function set_source_db($db_source)
	{
		$this->installer_config->set_converter_source_db($db_source);
	}

	public function set_destination_db($db_destination)
	{
		$this->installer_config->set_converter_destination_db($db_destination);
	}
