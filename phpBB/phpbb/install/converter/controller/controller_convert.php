...
class controller_convert
{
     ...
     */
    public function __construct($container, \phpbb\install\controller\helper $helper, \phpbb\language\language $language, \phpbb\template\template $template,  $phpbb_root_path)
    {
        $this->helper = $helper;
