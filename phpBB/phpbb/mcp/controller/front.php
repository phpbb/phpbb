	...
	public function main()
	{
		...
		if ($this->auth->acl_getf_global('m_approve'))
		{
			...
			if (!empty($forum_list))
			{
				...
				$this->template->assign_vars([
					...
					'L_UNAPPROVED_TOTAL'	=> $this->language->lang('UNAPPROVED_POSTS_TOTAL', (int) $total),
		...
		if ($this->auth->acl_getf_global('m_report'))
		{
			...
			if (!empty($forum_list))
			{
				...
				$this->template->assign_vars([
					'L_REPORTS_TOTAL'	=> $this->language->lang('REPORTS_TOTAL', (int) $total),
		...
		if ($this->auth->acl_get('m_pm_report'))
		{
			...
			$this->template->assign_vars([
				'L_PM_REPORTS_TOTAL'	=> $this->language->lang('PM_REPORTS_TOTAL', (int) $total),
		...
		return $this->helper->render('mcp_front.html', $this->language->lang('MCP_INDEX'));
	}
}
