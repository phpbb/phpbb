...
//		$db->sql_return_on_error(false);
	...
	*/
	function set_cookie($name, $cookiedata, $cookietime)
	{
		...
		$domain = (!$config['cookie_domain'] || $config['cookie_domain'] == 'localhost' || $config['cookie_domain'] == '127.0.0.1' || (strpos($config['cookie_domain'], '.') === false && strpos($config['cookie_domain'], ':') === false)  ? '' : '; domain=' . $config['cookie_domain'];
