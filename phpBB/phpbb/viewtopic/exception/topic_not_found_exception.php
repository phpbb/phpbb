 ...
 */
class topic_not_found_exception extends runtime_exception
{
	/**
	 * Constructor
	 *
	 ...
	 */
	public function __construct(string $message = 'NO_TOPIC', array $parameters = array(), \Exception $previous = null, int $code = 0)
	{
