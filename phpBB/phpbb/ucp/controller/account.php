...
class account
{
	...
	/** @var \phpbb\ucp\controller\reset_password */
	protected $ucp_reset_password;
	 ...
	 * @param \phpbb\ucp\controller\reset_password		$ucp_reset_password
	...
	function main($mode)
	{
		...
		switch ($mode)
		{
			...
			case 'reset_password':
				return $this->ucp_reset_password->reset();

			case 'forgot_password':
				return $this->ucp_reset_password->request();
