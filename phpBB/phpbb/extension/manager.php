...
class manager
{
	...
	*/
	public function __construct(ContainerInterface $container, \phpbb\db\driver\driver_interface $db, \phpbb\config\config $config, \phpbb\filesystem $filesystem, \phpbb\user $user, $extension_table, $phpbb_root_path, $php_ext = 'php', \phpbb\cache\service $cache = null, $cache_name = '_ext')
	{
		$this->cache = $cache;
	...
	*/
	...
	{
		return new \phpbb\extension\metadata_manager($name, $this->config, $this, $this->user, $this->phpbb_root_path);
	}
