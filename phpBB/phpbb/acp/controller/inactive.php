...
class inactive
{
	...
	public function main($page = 1)
	{
		...
		$sort_by_text = ['i' => $this->language->lang('SORT_INACTIVE'), 'j' => $this->language->lang('SORT_REG_DATE'), 'l' => $this->language->lang('SORT_LAST_VISIT'), 'd' => $this->language->lang('SORT_LAST_REMINDER'), 'r' => $this->language->lang('SORT_REASON'), 'u' => $this->language->lang('SORT_USERNAME'), 'p' => $this->language->lang('SORT_POSTS'), 'e' => $this->language->lang('SORT_REMINDER')];
