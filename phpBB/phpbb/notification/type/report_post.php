...
class report_post extends \phpbb\notification\type\post_in_queue
{
	...
	*/
	public function get_email_template_variables()
	{
		...
		return array(
			...
			'U_VIEW_REPORT'				=> $this->helper->route('mcp_report_details', ['f' => $this->get_data('forum_id'), 'p' => $this->item_id, '#' => 'reports'], false, false, UrlGeneratorInterface::ABSOLUTE_URL),
	...
	*/
	...
	{
		return $this->helper->route('mcp_report_details', ['f' => $this->get_data('forum_id'), 'p' => $this->item_id, '#' => 'reports']);
	}
