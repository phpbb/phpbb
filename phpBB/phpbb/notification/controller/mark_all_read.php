...
class mark_all_read
{
	...
	public function handle()
	{
		...
		{
			$this->helper->markread_all(false, $this->request->variable('mark_time', 0));
			...
			if ($this->request->is_ajax())
			{
				...
				$data = [
					...
					'U_MARK_FORUMS'		=> ($this->user->data['is_registered'] || $this->config['load_anon_lastread']) ? $controller_helper->route('notification.controller.mark_all_read', ['hash' => generate_link_hash('global'), 'mark_time' => time()]) : '',
