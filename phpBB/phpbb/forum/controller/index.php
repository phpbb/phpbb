...
//		page_header($page_title, true); // todo: decouple display_online_list somehow and move it to viewonline_helper after https://github.com/phpbb/phpbb/pull/5410
		return $this->controller_helper->render('index_body.html', $page_title);
	}
}
