...
function adm_page_header($page_title)
{
	...
	*/
	...
	$template->assign_vars(array(
		...
		'T_FONT_AWESOME_LINK'			=> !empty($config['allow_cdn']) && !empty($config['load_font_awesome_url']) ? $config['load_font_awesome_url'] : "{$phpbb_root_path}assets/css/all.min.css?assets_version=" . $config['assets_version'],
