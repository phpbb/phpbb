...
/**
* Minimum Requirement: PHP 8.4.0
*/
if (version_compare(PHP_VERSION, '8.4.0', '<'))
{
	die('You are running an unsupported PHP version (' . PHP_VERSION . '). Please upgrade to PHP 8.4.0 or higher before trying to install or update to phpBB 4.0');
}
