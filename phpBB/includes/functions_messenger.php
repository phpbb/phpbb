...
class messenger
{
	...
	*/
	protected function setup_template()
	{
		...
		$this->template = new \phpbb\template\twig\twig($phpbb_path_helper, $config, $user, new \phpbb\template\context(), $phpbb_extension_manager, $phpbb_container->get('proxy.factory'));
	}
