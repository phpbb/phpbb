...
*
* @package DBal
* @version $Id: dbal.php,v 1.1 2008/12/08 13:28:56 orynider Exp $
...
class dbal
{
	...
	*/
	function sql_error($sql = '')
	{
		...
		if (!$this->return_on_error)
		{
			...
			if ((@$userdata['user_level'] == ADMIN) || defined('INSTALLING'))
			{
	...
	*/
	...
	{
		global $cache, $starttime, $phpbb_root_path, $lang;
