		...
		switch ($action)
		{
			...
			case 'add':
				...
				$tpl_ary = array(
					...
					'L_BBCODE_USAGE_EXPLAIN'=> $user->lang('BBCODE_USAGE_EXPLAIN', '<a href="#down">', '</a>'),
			...
			case 'create':
				...
				*/
				...
				{
					confirm_box(false, 'BBCODE_DANGER', build_hidden_fields(array_merge($hidden_fields, array(
						'action'				=> $action,
						'bbcode'				=> $bbcode_id,
						'bbcode_match'			=> $bbcode_match,
