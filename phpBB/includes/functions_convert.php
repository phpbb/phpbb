...
function import_avatar_gallery($gallery_name = '', $subdirs_as_galleries = false)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_GALLERY_PATH', 'import_avatar_gallery()'), __LINE__, __FILE__);
	}
...
function import_attachment_files($category_name = '')
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_UPLOAD_DIR', 'import_attachment_files()'), __LINE__, __FILE__);
	}
...
function import_attachment($source, $use_target = false)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_UPLOAD_DIR', 'import_attachment()'), __LINE__, __FILE__);
	}
...
function import_rank($source, $use_target = false)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_RANKS_PATH', 'import_rank()'), __LINE__, __FILE__);
	}
...
function import_smiley($source, $use_target = false)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_SMILIES_PATH', 'import_smiley()'), __LINE__, __FILE__);
	}
...
function import_avatar($source, $use_target = false, $user_id = false)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_AVATAR_PATH', 'import_avatar()'), __LINE__, __FILE__);
	}
...
function get_smiley_dim($source, $axis)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_SMILIES_PATH', 'get_smiley_dim()'), __LINE__, __FILE__);
	}
...
function get_upload_avatar_dim($source, $axis)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_AVATAR_PATH', 'get_upload_avatar_dim()'), __LINE__, __FILE__);
	}
...
function get_gallery_avatar_dim($source, $axis)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_GALLERY_PATH', 'get_gallery_avatar_dim()'), __LINE__, __FILE__);
	}
...
function user_group_auth($group, $select_query, $use_src_db)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_WRONG_GROUP', $group, 'user_group_auth()'), __LINE__, __FILE__, true);
		return;
	}
	...
	if (!$group_id)
	{
		$convert->p_master->error($user->lang('CONV_ERROR_NO_GROUP', $group, 'user_group_auth()'), __LINE__, __FILE__, true);
		return;
	}
...
function copy_file($src, $trg, $overwrite = false, $die_on_failure = true, $source_relative_path = true)
{
	...
	{
		$convert->p_master->error($user->lang('COULD_NOT_COPY', $src_path, $phpbb_root_path . $trg_path), __LINE__, __FILE__, !$die_on_failure);
		return;
	}
...
function copy_dir($src, $trg, $copy_subdirs = true, $overwrite = false, $die_on_failure = true, $source_relative_path = true)
{
	...
	{
		$convert->p_master->error($user->lang('CONV_ERROR_COULD_NOT_READ', relative_base($src, $source_relative_path)), __LINE__, __FILE__);
	}
