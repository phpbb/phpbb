...
/**
 * Get name of the DateTime class we use
 *
 * Defaults back to \phpbb\datetime if not set.
 *
 * @param \phpbb\config\config $config
 * @return string Class name of the datetime class we should use
 */
function phpbb_get_datetime_class($config)
{
	return isset($config['datetime_class']) ? $config['datetime_class'] : '\phpbb\datetime';
