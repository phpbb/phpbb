...
function page_header($page_title = '', $display_online_list = false, $item_id = 0, $item = 'forum')
{
	...
	*/
	...
	$template->assign_vars(array(
		...
		'T_JQUERY_UI_LINK'		=> !empty($config['allow_cdn']) && !empty($config['load_jquery_ui_url']) ? $config['load_jquery_ui_url'] : "{$web_path}assets/javascript/jquery-ui.min.js?assets_version=" . $config['assets_version'],
