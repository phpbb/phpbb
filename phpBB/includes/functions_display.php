...
function display_forums($root_data = '', $display_moderators = true, $return_moderators = false)
{
	...
	*/
	...
	$template->assign_vars(array(
		'U_MARK_FORUMS'		=> ($user->data['is_registered'] || $config['load_anon_lastread']) ? (!empty($root_data['forum_id']) ? $controller_helper->route('phpbb_forum_mark_subforums_read', ['id' => (int) $root_data['forum_id'], 'hash' => generate_link_hash('global'), 'mark_time' => time()]) : $controller_helper->route('phpbb_forum_mark_all_read', ['hash' => generate_link_hash('global'), 'mark_time' => time()])) : '',
