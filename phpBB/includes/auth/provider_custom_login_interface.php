...
interface phpbb_auth_provider_custom_login_interface
{
	 ...
	 * @param boolean $full_login_box Whether this is a full login box or not.
	 * @return string|null On success, returns the rendered template $tpl; on failure, returns null.
	 */
	public function generate_login_box(phpbb_template $template, $redirect, $admin, $full_login_box);
}
