...
CREATE TABLE phpbb_attachments (
  ...
  post_msg_id mediumint(8) UNSIGNED NOT NULL,
  topic_id mediumint(8) UNSIGNED NOT NULL,
  in_message tinyint(1) UNSIGNED NOT NULL,
  ...
  filetime int(11) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_auth_groups (
  ...
  auth_option_id smallint(5) UNSIGNED NOT NULL,
  auth_setting tinyint(4) NOT NULL,
...
CREATE TABLE phpbb_auth_options (
  ...
  founder_only tinyint(1) NOT NULL,
...
CREATE TABLE phpbb_banlist (
   ...
   ban_exclude tinyint(1) NOT NULL,
...
CREATE TABLE phpbb_bbcodes (
  bbcode_id tinyint(3) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_cache (
  ...
  var_expires int(10) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_extension_groups (
  ...
  allow_in_pm tinyint(1) NOT NULL,
...
CREATE TABLE phpbb_forums (
   ...
   forum_rules_flags tinyint(4) UNSIGNED NOT NULL,
   forum_rules_bbcode_bitfield int(11) UNSIGNED NOT NULL,
   forum_rules_bbcode_uid varchar(5) DEFAULT '' NOT NULL,
   forum_topics_per_page tinyint(4) UNSIGNED NOT NULL,
   forum_type tinyint(4) NOT NULL,
   forum_status tinyint(4) NOT NULL,
   forum_posts mediumint(8) UNSIGNED NOT NULL,
   forum_topics mediumint(8) UNSIGNED NOT NULL,
   forum_topics_real mediumint(8) UNSIGNED NOT NULL,
   forum_last_post_id mediumint(8) UNSIGNED NOT NULL,
   forum_last_poster_id mediumint(8) NOT NULL,
   forum_last_post_time int(11) NOT NULL,
   forum_last_poster_name varchar(30),
   forum_flags tinyint(4) NOT NULL,
   ...
   enable_prune tinyint(1) NOT NULL,
...
CREATE TABLE phpbb_forums_marking (
   ...
   forum_id mediumint(9) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_groups (
   ...
   group_display tinyint(1) NOT NULL,
   group_avatar varchar(100) DEFAULT '' NOT NULL,
   group_avatar_type tinyint(4) NOT NULL,
   group_avatar_width tinyint(4) UNSIGNED NOT NULL,
   group_avatar_height tinyint(4) UNSIGNED NOT NULL,
   group_rank smallint(5) DEFAULT '-1' NOT NULL,
   group_colour varchar(6) DEFAULT '' NOT NULL,
   group_sig_chars mediumint(8) UNSIGNED NOT NULL,
   group_receive_pm tinyint(1) NOT NULL,
   group_message_limit mediumint(8) UNSIGNED NOT NULL,
   group_chgpass smallint(6) NOT NULL,
...
CREATE TABLE phpbb_modules (
  ...
  module_order mediumint(4) NOT NULL,
...
CREATE TABLE phpbb_poll_results (
  poll_option_id tinyint(4) UNSIGNED NOT NULL,
  topic_id mediumint(8) UNSIGNED NOT NULL,
  poll_option_text varchar(255) NOT NULL,
  poll_option_total mediumint(8) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_poll_voters (
  topic_id mediumint(8) UNSIGNED NOT NULL,
  poll_option_id tinyint(4) UNSIGNED NOT NULL,
  vote_user_id mediumint(8) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_posts (
   ...
   bbcode_bitfield int(11) UNSIGNED NOT NULL,
   bbcode_uid varchar(5) DEFAULT '' NOT NULL,
   post_edit_time int(11) UNSIGNED NOT NULL,
   post_edit_reason varchar(100),
   post_edit_user mediumint(8) UNSIGNED NOT NULL,
   post_edit_count smallint(5) UNSIGNED NOT NULL,
   post_edit_locked tinyint(1) UNSIGNED NOT NULL,
   PRIMARY KEY (post_id),
   KEY forum_id (forum_id),
   KEY topic_id (topic_id),
...
CREATE TABLE phpbb_privmsgs (
   ...
   message_edit_user mediumint(8) UNSIGNED NOT NULL,
   ...
   bbcode_bitfield int(11) UNSIGNED NOT NULL,
   bbcode_uid varchar(5) DEFAULT '' NOT NULL,
   message_edit_time int(11) UNSIGNED NOT NULL,
   message_edit_count smallint(5) UNSIGNED NOT NULL,
   to_address text,
   bcc_address text,
   PRIMARY KEY  (msg_id),
...
CREATE TABLE phpbb_privmsgs_rules (
   ...
   user_id mediumint(8) UNSIGNED NOT NULL,
   rule_check mediumint(4) UNSIGNED NOT NULL,
   rule_connection mediumint(4) UNSIGNED NOT NULL,
   rule_string varchar(255) DEFAULT '' NOT NULL,
   rule_user_id mediumint(8) UNSIGNED NOT NULL,
   rule_group_id mediumint(8) UNSIGNED NOT NULL,
   rule_action mediumint(4) UNSIGNED NOT NULL,
   rule_folder_id mediumint(8) UNSIGNED NOT NULL,
   PRIMARY KEY  (rule_id)
);
...
CREATE TABLE phpbb_privmsgs_to (
   ...
   forwarded tinyint(1) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_profile_fields (
   ...
   field_required tinyint(1) UNSIGNED NOT NULL,
   field_show_on_reg tinyint(1) UNSIGNED NOT NULL,
   field_hide tinyint(1) UNSIGNED NOT NULL,
   field_active tinyint(1) UNSIGNED NOT NULL,
   field_order tinyint(4) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_ratings (
  ...
  user_id tinyint(4) UNSIGNED UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_reports_reasons (
  ...
  reason_priority tinyint(4) NOT NULL,
...
CREATE TABLE phpbb_sessions (
   session_id varchar(32) DEFAULT '' NOT NULL,
   session_user_id mediumint(8) UNSIGNED NOT NULL,
   ...
   session_admin tinyint(1) NOT NULL,
...
CREATE TABLE phpbb_styles_template (
   ...
   bbcode_bitfield int(11) UNSIGNED NOT NULL,
   template_storedb tinyint(1) NOT NULL,
...
CREATE TABLE phpbb_styles_template_data (
   ...
   template_mtime int(11) NOT NULL,
   template_data text,
   KEY (template_id),
...
CREATE TABLE phpbb_styles_theme (
   ...
   theme_storedb tinyint(1) NOT NULL,
   theme_mtime int(11) NOT NULL,
...
CREATE TABLE phpbb_topics (
   ...
   topic_last_poster_id mediumint(8) UNSIGNED NOT NULL,
   topic_last_poster_name varchar(30),
   topic_last_post_time int(11) UNSIGNED NOT NULL,
   topic_last_view_time int(11) UNSIGNED NOT NULL,
   topic_moved_id mediumint(8) UNSIGNED NOT NULL,
   topic_bumped tinyint(1) UNSIGNED NOT NULL,
   topic_bumper mediumint(8) UNSIGNED NOT NULL,
   poll_title varchar(255) NOT NULL,
   poll_start int(11) NOT NULL,
   poll_length int(11) NOT NULL,
   poll_max_options tinyint(4) UNSIGNED DEFAULT '1' NOT NULL,
   poll_last_vote int(11) UNSIGNED DEFAULT '0',
   poll_vote_change tinyint(1) UNSIGNED NOT NULL,
...
CREATE TABLE phpbb_user_group (
   ...
   user_id mediumint(8) UNSIGNED NOT NULL,
   group_leader tinyint(1) NOT NULL,
...
CREATE TABLE phpbb_users (
   ...
   user_lastpost_time int(11) NOT NULL,
   user_lastpage varchar(100) DEFAULT '' NOT NULL,
   user_last_confirm_key varchar(10) DEFAULT '' NOT NULL,
   user_warnings tinyint(4) NOT NULL,
   ...
   user_new_privmsg tinyint(4) UNSIGNED NOT NULL,
   user_unread_privmsg tinyint(4) UNSIGNED NOT NULL,
   user_last_privmsg int(11) NOT NULL,
   user_message_rules tinyint(1) UNSIGNED NOT NULL,
   user_full_folder int(11) DEFAULT '-3' NOT NULL,
   user_emailtime int(11) NOT NULL,
   ...
   user_notify_type tinyint(4) NOT NULL,
   ...
   user_avatar_type tinyint(2) NOT NULL,
   user_avatar_width tinyint(4) UNSIGNED NOT NULL,
   user_avatar_height tinyint(4) UNSIGNED NOT NULL,
   user_sig text DEFAULT '' NOT NULL,
   user_sig_bbcode_uid varchar(5) DEFAULT '' NOT NULL,
   user_sig_bbcode_bitfield int(11) NOT NULL,
...
CREATE TABLE phpbb_zebra (
  user_id mediumint(8) UNSIGNED NOT NULL,
  zebra_id mediumint(8) UNSIGNED NOT NULL,
  friend tinyint(1) NOT NULL,
  foe tinyint(1) NOT NULL,
  KEY user_id (user_id),
