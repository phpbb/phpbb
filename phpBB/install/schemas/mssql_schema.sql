...
CREATE TABLE [phpbb_forums] (
	...
	[forum_last_post_id_real] [int] DEFAULT (0) NOT NULL ,
	[forum_last_poster_id_real] [int] DEFAULT (0) NOT NULL ,
	[forum_last_post_subject_real] [varchar] (255) DEFAULT ('') NOT NULL ,
	[forum_last_post_time_real] [int] DEFAULT (0) NOT NULL ,
...
CREATE TABLE [phpbb_topics] (
	...
	[topic_last_post_id_real] [int] DEFAULT (0) NOT NULL ,
	[topic_last_poster_id_real] [int] DEFAULT (0) NOT NULL ,
	...
	[topic_last_post_time_real] [int] DEFAULT (0) NOT NULL ,
