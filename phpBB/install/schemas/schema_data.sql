...
INSERT INTO phpbb_styles_imageset (imageset_id, imageset_name, imageset_copyright, imageset_path, btn_post, btn_post_pm, btn_reply, btn_reply_pm, btn_locked, btn_profile, btn_pm, btn_delete, btn_ip, btn_quote, btn_search, btn_edit, btn_report, btn_email, btn_www, btn_icq, btn_aim, btn_yim, btn_msnm, btn_online, btn_offline, btn_topic_watch, btn_topic_unwatch, icon_unapproved, icon_reported, icon_attach, icon_post, icon_post_new, icon_post_latest, icon_post_newest, forum, forum_new, forum_locked, forum_link, sub_forum, sub_forum_new, folder, folder_posted, folder_new, folder_new_posted, folder_hot, folder_hot_posted, folder_hot_new, folder_hot_new_posted, folder_locked, folder_locked_posted, folder_locked_new, folder_locked_new_posted, folder_sticky, folder_sticky_posted, folder_sticky_new, folder_sticky_new_posted, folder_announce, folder_announce_posted, folder_announce_new, folder_announce_new_posted, poll_left, poll_center, poll_right) VALUES (1, 'subSilver', '&copy; phpBB Group', 'subSilver', '"styles/imagesets/subSilver/{LANG}/btn_post.gif" width="82" height="25" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_post_pm.gif" width="82" height="25" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_reply.gif" width="82" height="25" border="0"', '"styles/imagesets/subSilver/{LANG}/reply.gif" width="88" height="25" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_locked.gif" width="82" height="25" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_profile.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_pm.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_delete.gif" width="16" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_ip.gif" width="16" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_quote.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_search.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_edit.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_report.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_email.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_www.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_icq.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_aim.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_yim.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_msnm.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_online.gif" width="59" height="18" border="0"', '"styles/imagesets/subSilver/{LANG}/btn_offline.gif" width="59" height="18" border="0"', '', '', '"styles/imagesets/subSilver/icon_unapproved.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/icon_reported.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/icon_attach.gif" width="14" height="18" border="0"', '"styles/imagesets/subSilver/icon_minipost.gif" width="12" height="9" border="0"', '"styles/imagesets/subSilver/icon_minipost_new.gif" width="12" height="9" border="0"', '"styles/imagesets/subSilver/icon_latest_reply.gif" width="18" height="9" border="0"', '"styles/imagesets/subSilver/icon_newest_reply.gif" width="18" height="9" border="0"', '"styles/imagesets/subSilver/folder_big.gif" width="46" height="25" border="0"', '"styles/imagesets/subSilver/folder_new_big.gif" width="46" height="25" border="0"', '"styles/imagesets/subSilver/folder_locked_big.gif" width="46" height="25" border="0"', '"styles/imagesets/subSilver/folder_link_big.gif" width="46" height="25" border="0"', '"styles/imagesets/subSilver/subfolder_big.gif" width="46" height="25" border="0"', '"styles/imagesets/subSilver/subfolder_new_big.gif" width="46" height="25" border="0"', '"styles/imagesets/subSilver/folder.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_new.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_new_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_hot.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_hot_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_new_hot.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_new_hot_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_lock.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_lock_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_lock_new.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_lock_new_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_sticky.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_sticky_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_sticky_new.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_sticky_new_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_announce.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_announce_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_announce_new.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/folder_announce_new_posted.gif" width="19" height="18" border="0"', '"styles/imagesets/subSilver/vote_lcap.gif" width="4" height="12" border="0"', '"styles/imagesets/subSilver/voting_bar.gif" height="12" border="0"', '"styles/imagesets/subSilver/vote_rcap.gif" width="4" height="12" border="0"');
