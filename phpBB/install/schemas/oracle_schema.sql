...
CREATE TABLE phpbb_forums (
	...
	enable_shadow_prune number(1) DEFAULT '0' NOT NULL,
	prune_shadow_next number(11) DEFAULT '0' NOT NULL,
	prune_shadow_days number(8) DEFAULT '0' NOT NULL,
	prune_shadow_freq number(8) DEFAULT '0' NOT NULL,
