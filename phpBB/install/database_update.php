		...
		'3.1.0-dev'		=> array(
			...
			'add_columns'		=> array(
				...
				STYLES_TABLE		=> array(
					...
					'style_inherits_id'		=> array('UINT:4', 0),
					'style_inherit_path'	=> array('VCHAR', ''),
				),
			),
			'change_columns'	=> array(
				GROUPS_TABLE		=> array(
	...
	switch ($version)
	{
		...
		case '3.1.0-dev':
			...
			$sql = 'DELETE FROM ' . MODULES_TABLE . "
			    WHERE module_basename = 'styles' AND (module_mode = 'imageset' OR module_name = 'theme' OR module_name = 'template')";
			_sql($sql, $errored, $error_ary);
			...
			$sql = 'INSERT INTO ' . STYLES_TABLE . " (style_name, style_copyright, style_active, style_path, bbcode_bitfield, style_inherits_id, style_inherit_path) VALUES ('prosilver', '&copy; phpBB Group', 1, 'prosilver', 'kNg=', 0, '')";
			_sql($sql, $errored, $error_ary);
