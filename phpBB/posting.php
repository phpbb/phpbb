...
$attachment_poster_id = $post_data['poster_id'];
...
* @var	int		attachment_poster_id	This holds the poster id to check the attachment data against, it can be set to null to diable checking
* @since 3.2.5-RC1
...
$attachment_poster_id = $attachment_poster_id === $post_data['poster_id'] ?: $attachment_poster_id;
